...
int main(int argc, char *argv[]) {
  ...
  randomOnOffHelper.SetAttribute("Interval", StringValue("ns3::ExponentialRandomVariable[Mean=2.33|Bound=0.0]"));
  randomOnOffHelper.SetAttribute("PacketSize", StringValue("ns3::UniformRandomVariable[Min=0|Max=1.0]"));
