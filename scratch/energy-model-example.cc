...
main (int argc, char *argv[])
{
  ...
  basicSourceHelper.Set ("BasicEnergySourceInitialEnergyJ", DoubleValue (400));
  // install source
  ...
  DeviceEnergyModelContainer models = networkNodes.Get(1)->GetObject<EnergySourceContainer>()->Get(0)->FindDeviceEnergyModels("ns3::WifiRadioEnergyModel");
  Ptr<WifiRadioEnergyModel> devModel = DynamicCast<WifiRadioEnergyModel>(models.Get(0));
  devModel->SetTxCurrentA(233);
  ...
  for (DeviceEnergyModelContainer::Iterator iter = deviceModels.Begin (); iter != deviceModels.End (); iter ++)
    {
      ...
      NS_ASSERT (energyConsumed <= 400);
      NS_LOG_UNCOND(DynamicCast<WifiRadioEnergyModel>(*iter)->GetTxCurrentA());
    }
